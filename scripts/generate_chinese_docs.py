...
9. Learning Agile Locomotion on Risky Terrains
10. Resilient Legged Local Navigation

## 第三批：MoE 改进

11. MoRE
12. CMoE
13. Parkour in the Wild
14. Reliable Sim-to-Real Predictability for MoE-based Robust Quadrupedal Locomotion
15. Quadruped Parkour Learning: Sparsely Gated Mixture of Experts with Visual Input

## 第四批：人形机器人扩展

16. Real-World Humanoid Locomotion with Reinforcement Learning
17. Humanoid-Gym
18. H2O
19. OmniH2O
20. WoCoCo
...
建议：不要等所有论文都读完再动手。读完 1、2、3 后就可以同步准备 baseline 复现环境。
""",
    )
...
本文整合 `docs/references/papers/` 下 23 篇论文，目标不是平均总结每篇论文，而是把文献转化为 2RL 项目的开发路线。
